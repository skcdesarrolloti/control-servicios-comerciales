...
<head>
  ...
  <title>Acceso — Control Servicios Comerciales</title>
...
<body>
  <div class="login-card">
    <div class="logo">
      ...
      <span class="logo-text">Control Servicios<br><span>Comerciales</span></span>
    </div>
    <h1>Iniciar sesión</h1>
    <p>Ingresa con las mismas credenciales de las demás aplicaciones internas.</p>
